...
//   LINK: 'https://tangly1024.com', // 网站地址
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '6eb136d8df914f24b8b399ad9003abda', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'mrhanmq@gmails.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/ByeYesterday',
  CONTACT_TELEGRAM: '',
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || '', // 你的Github仓库名 e.g 'tangly1024/Notion'
  ...
  // 无关紧要的配置
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Myyy BLOG', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '这是一个刚出生的站点', // 站点描述，被notion中的页面描述覆盖
